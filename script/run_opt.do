...
# =============================================================================
vlog -work work src/rtl_opt/pkg_keccak.sv
vlog -work work src/rtl_opt/keccak_round.sv
vlog -work work src/rtl_opt/keccak_round_constants_gen.sv
vlog -work work src/rtl_opt/keccak_dp.sv 
vlog -work work src/rtl_opt/keccak_cu.sv
vlog -work work src/rtl_opt/keccak_f.sv
